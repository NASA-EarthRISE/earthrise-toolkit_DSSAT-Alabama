...
ADMIN_NAMES = {"alabama": "County", "zimbabwe": "District"}
...
def init_columnRange_chart(session):
    ...
    my_chart.options.y_axis = {
        ...
        "plot_lines": [
            {
                "value": float(session.adminBase.obs_reference[1]/1000),
                "color": "#32323232",
                "width": 8,
                "dash_style": "Solid",
                "z_index": 99,
            ...
            {
                "value": float(session.adminBase.obs_reference[0]/1000),
                "color": "#32323232",
                "width": 3,
                "dash_style": "Dash",
                "z_index": 99,
            ...
            {
                "value": float(session.adminBase.obs_reference[2]/1000),
                "color": "#32323232",
                "width": 3,
                "dash_style": "Dash",
                "z_index": 99,
...
def current_forecast_yield_plot(session):
    ...
    if not any(np.isnan(session.adminBase.obs_reference)):
        min_value = float(session.adminBase.obs_reference[0]/1000)
        ...
        max_value = float(session.adminBase.obs_reference[2]/1000)
