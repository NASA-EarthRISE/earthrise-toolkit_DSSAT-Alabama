...
def sensitivity_charts(request):
    ...
    try:
        ...
        if session and hasattr(session, 'adminBase') and hasattr(session.adminBase, 'con'):
            session.adminBase.con.close()
...
def run_experiment(request):
    ...
    try:
        ...
        if hasattr(session, 'adminBase') and hasattr(session.adminBase, 'con'):
            session.adminBase.con.close()
